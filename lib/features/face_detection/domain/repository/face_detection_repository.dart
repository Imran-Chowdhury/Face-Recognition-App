...
abstract class FaceDetectionRepository{
  ...
  // Future detectFacesFromLiveFeed(InputImage inputImage, img.Image image, FaceDetector faceDetector);
  ...
  // List cropFacesFromLiveFeed(img.Image image, List<Face> face);
